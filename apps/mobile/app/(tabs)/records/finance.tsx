          ...
          <View style={styles.summaryCard}>
            ...
            <View style={styles.summaryRow}>
              ...
              <TouchableOpacity style={styles.summaryItem} activeOpacity={0.7} onPress={() => { setActiveCategory('전체'); Alert.alert('지출 내역', '식비: -119,900원\n교통: -65,000원\n교육: -350,000원\n여가: -48,000원\n의료: -15,000원\n주거: -185,000원\n\n지출 상세 보기 기능이 곧 추가됩니다.'); }}>
                ...
                <Text style={[styles.summaryAmount, { color: '#C05A4E' }]}>-782,900원</Text>
              </TouchableOpacity>
            </View>
              ...
              <View key={gi} style={styles.transGroup}>
                ...
                {group.items.map((item, ii) => (
                  ...
                  >
                    ...
                    <Text style={[styles.transAmount, { color: item.type === 'income' ? '#4AA86B' : '#C05A4E' }]}>
...
const styles = StyleSheet.create({
  ...
  summaryMonth: { fontSize: 16, fontWeight: '700', color: '#1F1F1F', marginBottom: 16, textAlign: 'center' },
  ...
  balanceAmount: { fontSize: 18, fontWeight: '700', color: '#1F1F1F' },
  ...
  chartLabelActive: { color: '#C05A4E', fontWeight: '700' },
  ...
  transInfo: { flex: 1 },
  transDesc: { fontSize: 14, fontWeight: '600', color: '#1F1F1F' },
