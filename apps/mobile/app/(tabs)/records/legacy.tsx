...
const s = StyleSheet.create({
  ...
  introContent: { flex: 1 },
  introTitle: { fontSize: 15, fontWeight: '700', color: '#2E7D32', marginBottom: 4, fontFamily: 'PretendardBold', letterSpacing: -0.3 },
  introDesc: { fontSize: 12, color: '#2E7D32', lineHeight: 18, fontFamily: 'Pretendard' },
  section: { paddingHorizontal: 20, marginBottom: 24 },
  sectionTitle: { fontSize: 18, fontWeight: '700', color: '#1F1F1F', marginBottom: 2, fontFamily: 'PretendardBold', letterSpacing: -0.3 },
  sectionSubtitle: { fontSize: 12, color: '#A0A0A0', marginBottom: 12, fontFamily: 'Pretendard' },
  ...
  msgInfo: { flex: 1 },
  msgRecipient: { fontSize: 15, fontWeight: '600', color: '#1F1F1F', marginBottom: 2, fontFamily: 'Pretendard' },
