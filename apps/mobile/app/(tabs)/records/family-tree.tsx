...
const s = StyleSheet.create({
  ...
  memberCard: { alignItems: 'center', width: 100, backgroundColor: '#FFFFFF', borderRadius: 16, padding: 16, borderWidth: 1, borderColor: '#EAEAEA' },
  ...
  memberName: { fontSize: 14, fontWeight: '700', color: '#1F1F1F', marginBottom: 2 },
  ...
  addText: { fontSize: 15, fontWeight: '600', color: '#C05A4E' },
});
