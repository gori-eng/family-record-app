...
const GENERATIONS = [
  {
    gen: '1세대 (조부모)',
    members: [
      { name: '김영수', relation: '할아버지', birth: '1945', color: '#B8D4E6', alive: false },
      { name: '이순자', relation: '할머니', birth: '1948', color: '#FFDAB9', alive: true },
    ],
  },
  {
    gen: '2세대 (부모)',
    members: [
      { name: '김민준', relation: '아빠', birth: '1990', color: '#B8D4E6', alive: true },
      { name: '박지수', relation: '엄마', birth: '1992', color: '#FFDAB9', alive: true },
    ],
  },
  {
    gen: '3세대 (자녀)',
    members: [
      { name: '김서준', relation: '아들', birth: '2018', color: '#B8E6C8', alive: true },
      { name: '김지우', relation: '딸', birth: '2022', color: '#FFB6C1', alive: true },
    ],
  },
];
    ...
    <>
      ...
      <View style={s.container}>
        <ScrollView showsVerticalScrollIndicator={false}>
          <View style={s.intro}>
            <FontAwesome name="sitemap" size={18} color="#C85A4A" />
          ...
          <TouchableOpacity style={s.addMember} activeOpacity={0.7}
            ...
            <FontAwesome name="plus-circle" size={18} color="#C85A4A" />
...
const s = StyleSheet.create({
  ...
  genSection: { paddingHorizontal: 20, marginBottom: 8 },
  genTitle: { fontSize: 14, fontWeight: '700', color: '#9C8B75', marginBottom: 8, textTransform: 'uppercase', letterSpacing: 0.5 },
  genLine: { height: 1, backgroundColor: '#F0E8D8', marginBottom: 16 },
  membersRow: { flexDirection: 'row', justifyContent: 'center', gap: 20 },
  memberCard: { alignItems: 'center', width: 100, backgroundColor: '#FFFFFF', borderRadius: 16, padding: 16, borderWidth: 1, borderColor: '#F0E8D8' },
  ...
  memberName: { fontSize: 14, fontWeight: '700', color: '#2D2D2D', marginBottom: 2 },
  memberRelation: { fontSize: 12, color: '#7A6B55', marginBottom: 2 },
  memberBirth: { fontSize: 11, color: '#9C8B75' },
  deceased: { fontSize: 10, color: '#C85A4A', fontWeight: '600', marginTop: 4 },
  connector: { alignItems: 'center', paddingVertical: 12 },
  connectorLine: { width: 2, height: 20, backgroundColor: '#F0E8D8' },
